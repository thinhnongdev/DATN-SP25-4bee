...
public class CreatePhieuGiamGiaRequest {
    ...
    public void setNgayBatDauFromLocalDateTime(LocalDateTime ngayBatDau) {
        this.ngayBatDau = ngayBatDau != null ? ngayBatDau.atZone(ZoneId.of("Asia/Ho_Chi_Minh")).toInstant() : null;
    }
    ...
    public void setNgayKetThucFromLocalDateTime(LocalDateTime ngayKetThuc) {
        this.ngayKetThuc = ngayKetThuc != null ? ngayKetThuc.atZone(ZoneId.of("Asia/Ho_Chi_Minh")).toInstant() : null;
    }

...
//     // Nếu là hóa đơn tại quầy (loai 1), chỉ có 3 trạng thái
...
//     }
//   };
//   // Thêm hàm tính toán số tiền cần thanh toán thêm
//   const calculateRemainingPayment = () => {
//     if (!invoice || !paymentHistory) return 0;

//     // Tổng tiền đơn hàng hiện tại
//     const currentTotal =
//       totalBeforeDiscount + (invoice.phiVanChuyen || 0) - getDiscountAmount();

//     // Tổng số tiền đã thanh toán
//     const totalPaid = paymentHistory.reduce(
//       (sum, payment) => sum + (payment.tongTien || 0),
//       0
//     );

//     // Số tiền còn thiếu
//     return Math.max(0, currentTotal - totalPaid);
//   };
...
//       // Gọi API cập nhật trạng thái kèm thanh toán
...
//       toast.success("Đã cập nhật trạng thái và thanh toán thành công");
//     } catch (error) {
...
//     try {
//       setProcessingPayment(true);
//       const paymentToastId = toast.loading("Đang xử lý thanh toán phụ phí...");

//       // Chuẩn bị dữ liệu thanh toán phụ phí
//       const paymentData = {
//         soTien: paymentAmount,
//         thanhToanRequest: {
//           maPhuongThucThanhToan: selectedPaymentMethod,
//           soTien: paymentAmount,
//           moTa: "Thanh toán phụ phí sau khi thêm sản phẩm",
//         },
//       };
...
//     }
//   };
//   // Thêm force-refresh cho Steps khi orderHistory thay đổi
...
//     // Xác định nextStatus: với đơn tại quầy (loại 1), từ trạng thái 2 (đã xác nhận) chuyển thẳng sang 5 (hoàn thành)
...
//       return;
//     }
//     if (nextStatus === 2 && (!paymentHistory || paymentHistory.length === 0)) {
//       // Load phương thức thanh toán và hiển thị modal
//       await loadPaymentMethods();
//       setPaymentAmount(invoice.tongTien || 0);
//       setOpenPaymentModal(true);
//       return;
//     }
//     try {
//       console.log("Updating status to:", nextStatus);
//       const updateToastId = toast.loading("Đang cập nhật trạng thái...");
...
//       // 3. Tải lại lịch sử trạng thái ngay lập tức
//       await fetchOrderHistory();

//       // 4. Chắc chắn force render Steps
//       forceUpdate();
...
//                 message="Bạn có thể điều chỉnh số tiền thanh toán"
//                 description="Hệ thống tự động đề xuất số tiền cần thanh toán, bạn có thể thay đổi số tiền này."
//                 type="info"
//                 showIcon
//               />
//             </div>
